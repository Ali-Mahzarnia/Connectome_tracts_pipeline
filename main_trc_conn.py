...
new_bvec = old_bvec [:, [1,0,2] ] # swap x and y
...
#mask_mif  =  subj_path+subj+'_mask.mif'
#os.system('echo dwi2mask '+den_unbiased_mif+  ' '+ mask_mif + ' -force')
#os.system('mrview '+den_unbiased_mif ) 
...
#os.system('dwigradcheck ' + out_mif +  ' -fslgrad '+bvec_path+ ' '+ bval_path +' -mask '+ mask_mif + ' -number 50000 -export_grad_fsl '+ new_bvec_path + ' '  + new_bval_path  +  ' -force' )
